...
export const api = {
  ...
  renameFavorite: (id: string, text: string) => request<any>(`/favorites/${id}`, { method: "PATCH", body: { text } }),
  reorderFavorites: (ids: string[]) => request<any>("/favorites/reorder", { method: "PUT", body: { ids } }),
